...
var choose = "green";
var def = "def";
var elem1 = 'ф1ф ф2ф ы3ы в4в а5а п6п р7р о8о л9л д0д 0д0 9л9 8о8 7р7 6п6 5а5 4в4 3ы3 2ф2 1ф1 ф1ф ф2ф ы3ы в4в а5а п6п р7р о8о л9л д0д 0д0 9л9 8о8 7р7 6п6 5а5 4в4 3ы3 2ф2 1ф1 ф1ф ф2ф ы3ы в4в а5а п6п р7р о8о л9л д0д 0д0 9л9 8о8 7р7 6п6 5а5 4в4 3ы3 2ф2 1ф1 ф1ф ф2ф ы3ы в4в а5а п6п р7р о8о'
   ...
   if (e.key==txt1){
     ...
     currentText(i)
      ...
      if ((i == len)&&(c==1))
      {
        ...
        i=0
        elem1='й1й й2й я1я я2я ц3ц ч3ч у4у с4с к5к м5м е6е и6и н7н т7т г7г ь7ь ш8ш б8б щ9щ ю9ю з0з .0. 0.0 9ю9 9щ9 8б8 8ш8 7ь7 7г7 7н7 7т7 6е6 6и6 5м5 5к5 4с4 4у4 3ч3 3ц3 2я2 2й2 1я1 1й1 й1й й2й я1я я2я ц3ц ч3ч у4у с4с к5к м5м е6е и6и н7н т7т г7г ь7ь ш8ш б8б щ9щ ю9ю з0з .0. 0.0 9ю9 9щ9 8б8 8ш8 7ь7 7г7 7н7'
        len = elem1.length
        currentText(i)
        c=2
      }
      ...
      if ((i == len)&&(c==2))
      {
        ...
        i=0
        elem1='121 232 343 454 565 676 787 898 909 0-0 -=- =-= -0- 090 989 878 767 656 545 434 323 212 121 232 343 454 565 676 787 898 909 0-0 -=- =-= -0- 090 989 878 767 656 545 434 323 212 121 232 343 454 565 676 787 898 909 0-0 -=- =-= -0- 090 989 878 767 656 545 434 323 212 121 232 343 454 565 676 787 898 909 0-0'
        len = elem1.length
        currentText(i)
        c=3
      }
      ...
      if ((i == len)&&(c==3))
      {
        ...
        i=0
        elem1='1!1 "2" 3№3 ;4; 5%5 :6: 7?7 *8* 9(9 )0) -_- +=+ =+= _-_ 0)0 (9( 8*8 ?7? 6:6 %5% 4;4 №3№ 2"2 !1! 1!1 "2" 3№3 ;4; 5%5 :6: 7?7 *8* 9(9 )0) -_- +=+ =+= _-_ 0)0 (9( 8*8 ?7? 6:6 %5% 4;4 №3№ 2"2 !1! 1!1 "2" 3№3 ;4; 5%5 :6: 7?7 *8* 9(9 )0) -_- +=+ =+= _-_ 0)0 (9( 8*8 ?7? 6:6 %5% 4;4 №3№ 2"2 !1! 1!1 "2" 3№3 ;4; 5%5 :6:'
        len = elem1.length
        currentText(i)
        c=4
      }
      ...
      if ((i == len)&&(c==4))
      {
        texty = texty + "#c_four {background: #95fd98} #c_five {background-image: linear-gradient(to right, #95fd98 50%, rgba(255, 255, 255, 0) 50%);}";
        ctrlText()
        len=len+4
        i=0
        elem1='В 1939 году началась 2-ая мировая война. В классе 34 человека. В 2020 году распространился вирус "Ковид-19".  Я выступаю под №7. Он сказал: "Я не люблю **". 50% всех работ написаны на 4. 3-2=1. 2+2=4. Это ужасно! Ты же ничего не забыл(-а)?'
        len = elem1.length
        currentText(i)
        c=5
      }
